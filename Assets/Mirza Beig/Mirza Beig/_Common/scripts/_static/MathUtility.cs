...
namespace MirzaBeig
{
    ...
    namespace Common
    {
        ...
        public static class MathUtility
        {
            ...
            // Float ranges for remapping.

            [System.Serializable]
            public class RemapRangeFloats : DualContainer<RangeFloat>
            {
                public RemapRangeFloats()
                {

                }
                public RemapRangeFloats(RangeFloat from, RangeFloat to)
                {
                    a = from;
                    b = to;
                }
                public RemapRangeFloats(float fromMin, float fromMax, float toMin, float toMax)
                {
                    a = new RangeFloat(fromMin, fromMax);
                    b = new RangeFloat(toMin, toMax);
                }
            }
            ...
            public static float remap(float value, RemapRangeFloats ranges, bool clamp = true)
            {
                return remap(value, ranges.a.min, ranges.a.max, ranges.b.min, ranges.b.max, clamp);
            }
